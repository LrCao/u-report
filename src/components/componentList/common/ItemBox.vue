<template>
  <div
    ...
    :class="[
      'tpf-mf-item',
      {
        'tpf-mf-item__active': data.makeStyle.active && !main.isShow,
        'tpf-mf-item__hover': !main.isShow,
      },
    ]"
  >
    <div class="tpf-mf-item__flex">
      <div class="tpf-mf-item--mask" v-if="showMask && !main.isShow"></div>
      <div class="tpf-mf-item--op" v-show="data.makeStyle.active && !main.isShow">
        <span class="tpf-mf-item--op--copy" @click="copy"
