<template>
  <item-box classSuffix="select">
    ...
    <el-form-item label="选项" v-if="!data.setting.isRemote">
      <el-checkbox-group v-model="data.value" v-if="data.multiple">
        <div
          class="tpf-mf-setting-select--multiple"
        ...
        >
          ...
          <span class="tpf-mf-setting-select--multiple--delete"
            ><i class="el-icon-delete" @click.stop="delSelect(item)"></i
          ></span>
          <span
            class="tpf-mf-setting-select--multiple--default-text"
      ...
      <div
        class="tpf-mf-setting-radio--radio"
        v-for="item in data.selections"
        :key="item.value"
        v-else
      >
        ...
        <span class="tpf-mf-setting-radio--radio--delete"
          ><i class="el-icon-delete" @click.stop="delSelect(item)"></i
        ></span>
        <span class="tpf-mf-setting-radio--radio--default-text" v-show="item.value === data.value"
          >默认选择</span
        >
      </div>
      <div class="tpf-mf-setting-select--add" v-if="inputing">
        <el-form
          :inline="true"
          :model="addForm"
    ...
    <template v-else>
      ...
      <el-form-item label="远程数据">
        ...
        >
          ...
          ></span>
          <span
            class="tpf-mf-setting-radio--radio--default-text"
    ...
    <el-form-item label="多选支持">
      <el-switch v-model="multiple" active-text="开启" inactive-text="关闭"></el-switch>
    </el-form-item>
  </item-box>
</template>
