<template>
  <item-box classSuffix="date-picker">
    ...
    <el-form-item label="默认值">
      <el-input v-model="defaultValue" @blur="defaultValueBlur"></el-input>
    </el-form-item>
    <el-form-item label="提示">
      <el-input v-model="data.placeholder"></el-input>
    </el-form-item>
    <el-form-item label="类型格式">
      <el-select v-model="data.setting.type" placeholder="请选择格式">
        <el-option label="年" value="year"></el-option>
        <el-option label="年月" value="month"></el-option>
        <el-option label="年月日" value="date"></el-option>
        <el-option label="年月日周" value="week"></el-option>
        <el-option label="年月日 时间" value="datetime"></el-option>
      </el-select>
    </el-form-item>
